---
title: "IAN User Sign In"
date: 2026-05-18T10:16:57+07:00
weight: 4
chapter: false
pre: " <b> 3.4 </b> "
---
...
1. Navigate to the [AWS Sign in](https://signin.aws.amazon.com/signup?request_type=register).
...
2. In the **IAM user sign in**
    ...
    - **Account ID**: enter ``your-account-ID``, example: **Account ID**: 123456789012
